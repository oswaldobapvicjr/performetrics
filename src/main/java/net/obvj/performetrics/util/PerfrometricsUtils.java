...
public class PerfrometricsUtils {
	...
	/**
	 * Returns the current value of the current Java Virtual Machine's
	 * high-resolution time source in nanoseconds. time in nanoseconds.
	 * 
	 * @return the difference, measured in nanoseconds between current time and some
	 *         arbitrary origin time for the current JVM, that can be used for
	...
	/**
	 * Returns the total time spent using a CPU for the current thread in
	 * nanoseconds.
	 * 
	 ...
	 * nanoseconds (i.e., is the time spent running current thread's own code).
	 * 
	...
	/**
	 * Returns system time (the time spent running OS code on behalf of your
	 * application, such as for I/O) in nanoseconds, by calculating the difference
	 * between CPU time and user time for the current thread.
	 * 
